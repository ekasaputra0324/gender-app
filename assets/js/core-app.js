...
function getTahunVeri(){
	...
	$.ajax({
		type: "GET",
		url: baseURL + '/urusan/get_tahun/'.concat(kode_b),
		dataType: "JSON",
		success: function (response) {
			console.log(response);
			var selectTahun = $('#tahun');
...
function getBidang(){
	...
	$.ajax({
		type: "GET",
		url: baseURL + '/urusan/get_bidang/'.concat(opd),
		dataType: "JSON",
		success: function (response) {
;
...
function syncveri(e){
	...
	let tahun = $('#tahun').val();
	let kode = $('#opd').val();
	console.log(baseURL + '/urusan/async?kode_b='.concat(kode_b) + '&tahun='.concat(tahun)+'&opd='.concat(kode));
	$.ajax({
		type: "GET",
		url: baseURL + '/urusan/async?kode_b='.concat(kode_b) + '&tahun='.concat(tahun)+'&opd='.concat(kode),
		dataType: "JSON",
		success: function (response) {
			console.log(response);
			let tbody = $('#urusan-tbody');
...
function cetakUrusan(e){
	...
	let tahun = $('#tahun').val();
	let kode = $('#opd').val();
	window.location.href = baseURL + '/laporan/cetakUrusan?kode_b='.concat(kode_b) + '&tahun='.concat(tahun)+'&opd='.concat(kode)
}
