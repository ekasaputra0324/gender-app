<div class="row">
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title text-capitalize">Laporan Data Pegawai</h4>
				<p class="card-title-desc text-capitalize">cetak laporan data Pegawai.</p>
				<form action="<?= site_url('laporan/cetakPegawai/') ?>" method="GET">
