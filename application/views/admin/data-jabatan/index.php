		...
		<div class="card">
			<div class="card-body">
				...
				<div class="d-flex gap-2">
					<button  data-url="<?= base_url("logicposition/getChart/$type/$user->agency_id") ?>" class="btn btn-secondary grafik-button mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Lihat Grafik</button>
					<a href="<?= base_url("datajabatan/form/$type") ?>" class="btn btn-primary mb-3">Tambah Data</a>
				</div>
				<?php } ?>
								...
								<td  class="text-center">
									<?php if ($role == 'ADMIN_OPD') {?>
										...
										<?php }elseif($role == 'SUPER_ADMIN') {?>
											<a href="<?= base_url("superadmin/show/$data->year/$data->agency_id/$data->user_id/$data->type/jabatan") ?>" class="btn btn-secondary"><i class="mdi mdi-eye-circle-outline"></i></a>
									<?php } ?>
								</td>
							</tr>
